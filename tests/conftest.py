...
from mytardis_rocrate_builder.src.rocrate_builder import ROBuilder
...
def test_metadata_list(
    ...
    return {test_mytardis_metadata.name: test_mytardis_metadata, test_sensitive_metadata.name:  test_sensitive_metadata}
